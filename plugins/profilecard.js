...
cmd({
  ...
  try {
    ...
    if (!args.length) {
      return reply(
`✨ *Example Usage:*
.profilecard name=DARKZONE-MD rankName=Pro rankId=2 level=15 exp=500 requireExp=900 avatarURL=https://files.catbox.moe/q3igju.jpg backgroundURL=https://files.catbox.moe/7tmoej.jpg
